...
///
/// [CupertinoTabViewCustom] configures the top-level [Navigator] to search for routes
...
///
/// These navigation properties are not shared with any sibling [CupertinoTabViewCustom]
/// nor any ancestor or descendant [Navigator] instances.
///
/// To push a route above this [CupertinoTabViewCustom] instead of inside it (such
...
///    [CupertinoTabViewCustom]'s [Navigator].
class CupertinoTabViewCustom extends StatefulWidget {
  /// Creates the content area for a tab in a [CupertinoTabScaffold].
  const CupertinoTabViewCustom({
    super.key,
    this.builder,
    this.navigatorKey,
    this.defaultTitle,
    ...
    this.initialRoute,
          ...
          (builder != null || initialRoute != null),
          'Either the builder property must be specified, '
          'or the routes, onGenerateRoute, and onUnknownRoute '
          'properties must be specified, but '
          'perhaps you were intending to specify '
          'a routes table containing a "/" entry?',
        );
  ...
  ///
  /// Rebuilding a [CupertinoTabViewCustom] with a different [builder] will not clear
  ...
  /// this [CupertinoTabViewCustom].
  ///
  /// {@macro flutter.widgets.navigator.restorationScopeId}
  final String? restorationScopeId;

  @override
  State<CupertinoTabViewCustom> createState() => _CupertinoTabViewCustomState();
}

class _CupertinoTabViewCustomState extends State<CupertinoTabViewCustom> {
  ...
  @override
  void didUpdateWidget(CupertinoTabViewCustom oldWidget) {
