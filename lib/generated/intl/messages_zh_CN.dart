...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(message) => "请求数据时应用出现问题，请联系管理员解决问题： ${message}";
  ...
  static String m29(minute) => "${minute} 分钟前";
  ...
  static String m33(itemCount) => "${itemCount} 项";
  ...
  static String m39(percent) => "销售额 ${percent}%";
  ...
  static String m47(total) => "${total} 个商品";
  ...
  static String m54(length) => "我们找到了 ${length} 件商品";

  static String m55(week) => "第 ${week} 周";
